...
- Lutris installed
- GE-Proton10-1 installed (To comfortably install and keep up to date GE-Proton, I recommand to use the application <a href="https://github.com/Vysp3r/ProtonPlus">ProtonPlus</a>)
